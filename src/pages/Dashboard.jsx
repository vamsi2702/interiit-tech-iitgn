              ...
              <main className="col-span-1">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between animate-slideIn mb-6">
                    <div>
                      <h1 className="text-4xl font-bold bg-gradient-to-r from-green-500 via-emerald-400 to-green-600 bg-clip-text text-transparent drop-shadow-2xl gradient-animate">
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        ...
                        >
                          Top 10 Companies Leading in ESG & Innovation
                        </p>
                        {lastUpdate && (
                        ...
                        <Link
                          ...
                          className={`group relative overflow-hidden ${
                            theme === "dark"
                              ...
                              : "bg-white border-gray-200"
                          } backdrop-blur-xl rounded-2xl shadow-xl hover:shadow-green-500/40 transition-all duration-500 p-6 border hover:border-green-500 animate-slideIn hover-lift`}
                              ...
                              <p
                                className={`text-xs ${
                                  theme === "dark"
                                    ? "text-slate-500"
                                    : "text-slate-600"
                                } mb-1 uppercase tracking-wider font-semibold`}
                              >
                                Stock Price
                              </p>
                              <p
