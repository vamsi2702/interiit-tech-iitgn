      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        {isCompany && (
          <>
              ...
              <div className="flex justify-between items-start">
                <div>
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-green-400 via-emerald-300 to-green-400 bg-clip-text text-transparent">{company.name}</h1>
                  ...
                  <div className="flex items-center space-x-8">
                    ...
                    <div>
                      ...
                      <p className="text-3xl font-bold text-green-400">{company.esg_rating}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 mb-8 animate-slideIn" style={{animationDelay: '0.1s'}}>
              ...
              <form onSubmit={handleAsk} className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-6 py-3 bg-slate-800/50 border border-green-500/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 text-slate-200 placeholder-slate-500"
                />
                <button 
                  type="submit"
                  className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-xl hover:shadow-lg hover:shadow-green-500/50 transition-all hover:scale-105 flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.2s'}}>
              ...
              <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.3s'}}>
                <h2 className="text-2xl font-bold text-green-400 mb-4">Sustainability Insights</h2>
                <div className="space-y-4">
                  <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
                    <h3 className="font-semibold text-green-300 mb-2">Latest Update</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.4s'}}>
                <h2 className="text-xl font-bold text-green-400 mb-4 flex items-center gap-2">
                ...
                <div className="grid grid-cols-3 gap-3 mt-4">
                  <div className="text-center p-3 bg-slate-800/50 rounded-lg">
                    ...
                    <p className="text-xl font-bold text-green-400">450M</p>
                    <p className="text-xs text-emerald-400">↓ 47%</p>
                  </div>
                  <div className="text-center p-3 bg-slate-800/50 rounded-lg">
              ...
              <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.5s'}}>
                <h2 className="text-xl font-bold text-green-400 mb-4">ESG Performance Breakdown</h2>
                <ResponsiveContainer width="100%" height={280}>
              ...
              <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.6s'}}>
                <h2 className="text-xl font-bold text-green-400 mb-4">Renewable Energy Transition</h2>
                <ResponsiveContainer width="100%" height={280}>
                ...
                <div className="mt-4 p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                  <p className="text-sm text-green-300 font-semibold">Q1 2025: 75% Renewable Energy</p>
                  <p className="text-xs text-slate-400 mt-1">67% increase since Q1 2024</p>
                </div>
              </div>

              {/* Energy Mix Pie Chart */}
              <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.7s'}}>
                <h2 className="text-xl font-bold text-green-400 mb-4">Current Energy Mix</h2>
                <ResponsiveContainer width="100%" height={280}>
                  <PieChart>
                    <Pie
                      data={energyMixData}
              ...
              <div className="lg:col-span-2 bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.8s'}}>
                <h2 className="text-xl font-bold text-green-400 mb-4 flex items-center gap-2">
            ...
            <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 mb-8 animate-slideIn" style={{animationDelay: '0.9s'}}>
              <h2 className="text-2xl font-bold text-green-400 mb-4 flex items-center gap-2">
          ...
          <>
            ...
            <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 mb-8 border border-green-500/30 animate-slideIn">
              <div className="flex justify-between items-start">
                <div>
                  <div className="flex items-center space-x-3 mb-2">
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-green-400 via-emerald-300 to-green-400 bg-clip-text text-transparent">{project.name}</h1>
                    <span className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-lg">
                      {project.id}
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Details Card */}
              <div className="lg:col-span-2 bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.1s'}}>
                <h2 className="text-2xl font-bold text-green-400 mb-6">Project Details</h2>
              ...
              <div className="space-y-6">
                {/* Market Data */}
                <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.2s'}}>
                  <h2 className="text-xl font-bold text-green-400 mb-4">Market Data</h2>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/40 rounded-xl">
                      ...
                      <p className="text-4xl font-bold text-green-400">${project.price}</p>
                    </div>
                ...
                <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-green-500/30 animate-slideIn" style={{animationDelay: '0.3s'}}>
                  ...
                  >
                    <button className="w-full bg-gradient-to-r from-green-600 via-emerald-600 to-green-600 text-white py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-green-500/50 transition-all hover:scale-105 flex items-center justify-center gap-3 animate-glow">
